...
import ru.yandex.practicum.service.FilmValidationDBService;
...
public class FilmDbStorage implements FilmStorage {
    ...
    @Autowired
    private FilmValidationDBService filmValidationDBService;
    @Autowired
    ...
    private void fillFilmLikeListForFilm(Film film) {
        film.setFilmLikes(new HashSet<>(fillFilmLikeList(film.getId())));
    }
    ...
    public Film updateFilm(Film film) {
        checkFilmValidation(film);
        filmValidationDBService.checkIdDatabase(film.getId());
    ...
    public Film getFilmById(int id) {
        filmValidationDBService.checkIdDatabase(id);
    ...
    public Film addLikeFilm(int filmId, int userId) {
        filmValidationDBService.checkLikeInDatabase(filmId, userId);
        filmValidationDBService.checkIdDatabase(filmId);
